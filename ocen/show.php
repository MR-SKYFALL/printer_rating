...
<div id="php">
	<div id="head_bar2" >
        <button type="button" style='width=100%'  class="btn btn-secondary btn-lg btn-block">Wybierz drukarke która chcesz ocenić</button>
...
echo<<<HTML2
	...
	<form action='ocen_wybrane/index.php' method='POST'>

		<div class='perfect_centering' >
		<input type='hidden' name='id_modyfikuj' value='$drukarka_ID' >
		<input class="btn btn-outline-primary" type='submit' value='oceń' name='button_usun' >
